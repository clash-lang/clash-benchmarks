#!/usr/bin/env python3
"""List the master commits that still need a benchmark on one machine.
...
Usage:
  ...
  --ref REF          master ref in the clone (default origin/master)
...
It walks the first-parent commits of master, from the newest one back,
